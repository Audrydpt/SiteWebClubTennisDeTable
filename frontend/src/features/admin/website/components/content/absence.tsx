...
import { CalendarX, Eye, Trash2, Download, Filter } from 'lucide-react';
...
export default function AbsenceManager() {
  ...
  const filteredAbsences = absences.filter((absence) => {
    ...
    const matchesStatus =
      statusFilter === 'all' ||
      (statusFilter === 'active' && absence.statut === 'active') ||
      (statusFilter === 'past' && isDatePast(absence.date));
  ...
  const stats = {
    ...
    active: absences.filter((a) => a.statut === 'active' && !isDatePast(a.date)).length,
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mb-2">
                            {absence.details.length > 100
                              ? `${absence.details.substring(0, 100)}...`
                              : absence.details}
                          </p>
